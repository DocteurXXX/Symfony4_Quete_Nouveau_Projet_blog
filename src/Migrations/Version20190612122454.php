 ...
 */
final class Version20190612122454 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE name name VARCHAR(150) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
